...
hurl invoke did did_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- did org1
# Install to your blockchain - From the root of your project
hurl install did node -P ./chaincode-did
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install did node -P ./chaincode-did --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade did node 1.2 -P ./chaincode-did
```
