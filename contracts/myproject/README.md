...
hurl invoke mychaincode mychaincode_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- mychaincode org1
# Install to your blockchain - From the root of your project
hurl install mychaincode node -P ./chaincode-mychaincode
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install mychaincode node -P ./chaincode-mychaincode --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade mychaincode node 1.2 -P ./chaincode-mychaincode
```
